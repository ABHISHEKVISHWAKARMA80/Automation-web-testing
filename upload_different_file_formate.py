...
#driver.find_element_by_id("file").send_keys("C:/MY IDENTITY/bonafide.pdf")
...
driver.find_element_by_id("file").send_keys("C:/Users/hp/Downloads/SamplePNGImage_500kbmb.png")
